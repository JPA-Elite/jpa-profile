...
from Controllers.web.AdminPageController import admin_dashboard_route, admin_login_route, admin_logout_route, admin_music_route, admin_settings_route, admin_video_route
