...
from Controllers.AdminPageController import admin_chat_route, admin_dashboard_route, admin_login_route, admin_logout_route, admin_music_route, admin_project_route, admin_settings_route, admin_video_route
